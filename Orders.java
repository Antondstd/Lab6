...
public class Orders {
    ...
    public static void info(ConcurrentHashMap<String, Human> collection, DatagramPacket request){
        sout="";
        String sout = new String("Коллкция имеет тип ConcurrentHashMap и содержит в себе объекты типа Human \n" +
     ...
     * @return collection
     */
    public static synchronized ConcurrentHashMap<String, Human> removeGreaterCollection(ConcurrentHashMap<String, Human> collection, String value){
        try {
            final String valueFinal = gson.fromJson(value, Key.class).toString();
